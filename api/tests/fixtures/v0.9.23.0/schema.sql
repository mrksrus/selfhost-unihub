-- Frozen v0.9.23.0 fresh-install schema; never derive this from current production code.
-- Tag commit: e8813669c75ada5bad870d0f9c380083934ed291
-- Source: api/src/services/database.js
-- Source Git blob: 7ab3856498bae1588c5814d706afac9bd9e4277a
-- All 29 CREATE TABLE statements, the calendar FK, and two backup indexes.
-- See README.md for provenance, scope, and reproduction instructions.
...
CREATE TABLE IF NOT EXISTS backup_archive_keys (
