...
This guide describes the supplied Compose deployment for **0.10.10**. It separates
...
to `ghcr.io/mrksrus/selfhost-unihub:0.10.10`. Use release tags, not a mutable `latest`
